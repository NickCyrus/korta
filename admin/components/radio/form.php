...
<div class="nc-cards cards-toggle">
    <div class="nc-card-header">
        <div class="nc-row">
            <div class="nc-col-auto nc-align-items-center nc-d-flex"><i class="bi bi-ui-radios nc-mr-3"></i> <?php echo "<code>$shortcode</code>"  ?? '' ?></div>
    ...
    <div class="nc-card-body nc-border nc-hide">
            ...
            <div class="nc-mb-2 nc-row">
                ...
                <div class="nc-col">
                    <ul class="nc-m-0 nc-p-0 sortable" id="ul-<?php echo $uniqId ?>">
